...
const TransOverview = () => {
  ...
  return (
    <TableContainer>
      <Table aria-label="simple table" ref={containerRef}>
        <TableHead>
          <TableRow>
            <TableCell>
              <Card
                ...
                <Card.Body>
                  <Container style={{ padding: "0px" }}>
                    <Row style={{ padding: "10px" }}>
                      ...
                      <Col>
                        <p style={{ color: "dodgerblue", marginLeft: "124px" }}>
                          +{" "}
                          {myWallet.inflow === ""
                            ...
                            : new Intl.NumberFormat("vi-VN", {
                                style: "currency",
                                currency: "VND",
                              }).format(myWallet.inflow)}
                        </p>
                        <p style={{ color: "red", marginLeft: "124px" }}>
                          -{" "}
                          {myWallet.outflow === ""
                            ? new Intl.NumberFormat("vi-VN", {
                                style: "currency",
                                ...
                                {item.transOfDate.map((tran) => {
                                  return (
                                    <div
                                      ...
                                      onMouseOver={(event) => handleOver(event)}
                                      onClick={() => handleClick(tran)}
                                    >
                                      <div>
                                        <p
                                          style={{
