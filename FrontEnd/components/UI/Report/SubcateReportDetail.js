        ...
        return (
            <div style={{backgroundColor: "white"}}>
                ...
                <div style={{marginTop: '8px'}}>
                    {props.subCate.trans.map(item => {
                        return (
                            <div className={styles.div} onClick={() => handleOpenDialog(item)} style={{width: '90%', borderBottom: '1px solid #ccc', marginLeft: "auto", marginRight: "auto", display: "flex", alignItems: "center", justifyContent: "space-between", padding: '8px'}}>
